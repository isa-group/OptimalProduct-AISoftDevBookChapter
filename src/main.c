...
//  =======================================================================
//   The original authors of this source code have given permission to use it 
//   as an example in the chapter about Cloud development, and deployment of 
//   the ai4software book. 
//   The source code has been slightly modified by J. A. Parejo, but main
//   authoriship and implementations was developed by Miqing Li and Wei Zheng
===========================================================================*/
